...
class Container_8d312aee85 extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_8d312aee85 $container)
			{
	...
	public function createServiceContainer(): Container_8d312aee85
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHPRC' => 'C:\Users\Fury\AppData\Local\Temp\16lA20C.tmp',
				...
				'windir' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\Fury\AppData\Local\Temp\16lA20C.tmp|0|*|*|C:\Users\Fury\.config\herd\bin\php84\php.ini|3.4.7',
				'ZES_ENABLE_SYSMAN' => '1',
			],
		];
	}
