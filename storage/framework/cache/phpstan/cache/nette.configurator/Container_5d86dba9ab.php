...
class Container_5d86dba9ab extends _PHPStan_e870ac104\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0381(): PHPStan\File\FileExcluderRawFactory
	{
		return new class ($this) implements PHPStan\File\FileExcluderRawFactory {
			...
			public function __construct(Container_5d86dba9ab $container)
			{
	...
	public function createServiceContainer(): Container_5d86dba9ab
	{
		return $this;
	}
	...
	protected function getStaticParameters(): array
	{
		return [
			...
			'env' => [
				...
				'PHPRC' => 'C:\Users\Fury\AppData\Local\Temp\0ci30F.tmp',
				...
				'VITE_APP_NAME' => '',
				'windir' => 'C:\WINDOWS',
				'XDEBUG_HANDLER_SETTINGS' => 'C:\Users\Fury\AppData\Local\Temp\0ci30F.tmp|0|*|*|C:\Users\Fury\.config\herd\bin\php84\php.ini|3.4.7',
				'ZES_ENABLE_SYSMAN' => '1',
			],
		];
	}
